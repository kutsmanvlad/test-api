 ...
 */
final class Version20200920200434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, name_test LONGTEXT NOT NULL, identifier VARCHAR(50) DEFAULT NULL, description LONGTEXT NOT NULL, date_create DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
